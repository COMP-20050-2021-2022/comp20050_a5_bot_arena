...
public class TextUI implements ui.UI {
    ...
    @Override
    public void notifyTimeOut(Player player){
        System.out.println();
        System.out.printf("TIMEOUT: Player %s took too long to think!\n",player.getName());
    }
    @Override
    public void displayGameOverMessage(Player winner) {
        ...
        System.exit(winner.getPlayerNo());
    }
    ...
    public void displayMove(Move move) {
        System.out.printf("\nPlayer %s (%s) places gamepiece '%s' at (%d,%d):\n",
                move.getPlayer().getName(),
                playerSymbol[move.getPlayer().getPlayerNo()],
                move.getGamepieceName(),
                move.getLocation().getX(),
                move.getLocation().getY());
        displayGamepiece(move.getGamepiece());
    }
